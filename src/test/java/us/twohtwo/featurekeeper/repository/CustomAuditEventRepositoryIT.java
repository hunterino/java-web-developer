...
import us.twohtwo.featurekeeper.config.audit.AuditEventConverter;
import us.twohtwo.featurekeeper.domain.PersistentAuditEvent;
...
import static us.twohtwo.featurekeeper.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
